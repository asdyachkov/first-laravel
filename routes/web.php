...
//
////Comment
//Route::resource('comment', CommentController.php::class);
//Route::get('/comment/{comment}/accept', [CommentController.php::class, 'accept']);
//Route::get('/comment/{comment}/reject', [CommentController.php::class, 'reject']);
