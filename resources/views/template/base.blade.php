...
<header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
            ...
            <div class="navbar-nav d-flex justify-content-end text-white">
                @guest
                    <li class="nav-item">
                ...
                @auth
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-dark text-white" style="border: solid thin white">
                            @foreach(auth()->user()->unreadNotifications as $notification)
                                <li><a style="max-width: 150px; overflow: hidden; padding: 5px" class="text-center dropdown-item bg-dark text-white" href="/article/show/{{$notification->data['name']['id']}}?notify={{$notification->id}}">{{$notification->data['name']['name']}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    <li class="nav-item">
